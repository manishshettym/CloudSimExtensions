	...
	public static void main(String[] args) {
		...
		try {
			...
			// First step: Initialize the CloudSim package. It should be called
				...
				cloudletList = createCloudlet(brokerId,4); // creating 40 cloudlets

				vmlist = createVM(brokerId,cloudletList.size()); //creating 20 vms
				
				
				broker.setfailurezones(data);
