...
public class SectorAllocationSimple extends PowerVmAllocationPolicyAbstract
{
	protected List<? extends Sector> sectorList;
	
	public SectorAllocationSimple(List<? extends Host> list, List<? extends Sector> sectorList) {
		super(list); // hostList List<? extends Host>
